...
mc_elbo <- function(phi, N = 10000){
  ...
  eta <- cbind(
    qtp3(U[,1], mu[1], sigma1[1], sigma2[1], FUN = qnorm),
    qtp3(U[,2], mu[2], sigma1[2], sigma2[2], FUN = qnorm),
    qtp3(U[,3], mu[3], sigma1[3], sigma2[3], FUN = qnorm),
    qtp3(U[,4], mu[4], sigma1[4], sigma2[4], FUN = qnorm)
  )
...
eta_samples_copula <- cbind(
  qtp3(U_samples[,1], mu[1], sigma1[1], sigma2[1], FUN = qnorm),
  qtp3(U_samples[,2], mu[2], sigma1[2], sigma2[2], FUN = qnorm),
  qtp3(U_samples[,3], mu[3], sigma1[3], sigma2[3], FUN = qnorm),
  qtp3(U_samples[,4], mu[4], sigma1[4], sigma2[4], FUN = qnorm)
)
